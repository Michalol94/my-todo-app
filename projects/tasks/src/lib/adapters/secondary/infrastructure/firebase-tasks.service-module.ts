...
@NgModule({
	...
	declarations: [],
	providers: [FirebaseTasksService, { provide: ADDS_TASK_DTO, useExisting: FirebaseTasksService }, { provide: GETS_ALL_TASK_DTO, useExisting: FirebaseTasksService }, { provide: REMOVES_TASK_DTO, useExisting: FirebaseTasksService }, { provide: SETS_TASK_DTO, useExisting: FirebaseTasksService }],
	exports: []
})
